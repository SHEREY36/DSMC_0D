...
def update_nested(cfg, AR, mode, p_eta, output_root, workers, vss_table,
    ...
    cfg["calibration"]["C_alpha_table_file"] = f"models/C_alpha_table_{ar_tag}.json"
    cfg["calibration"]["theta_target_table_file"] = (
        f"models/theta_target_table_{ar_tag}.json"
    )
