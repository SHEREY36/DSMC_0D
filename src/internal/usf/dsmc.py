...
from src.simulation.pressure import compute_pij_k, accumulate_pij_c, normalise_pij_c
from src.internal.non_gaussian.simulation_diagnostics import NonGaussianDiagnostics
    ...
    try:
        ...
        with open(
            ...
            while (
                ...
                if ng_diag.sample_axis == "t":
                    ng_diag.maybe_sample(
                        t, NColl / float(Np), step_count, vel, Er, Ttrans, Trot
                    )
